            ...
            <div>
                <div className='grid grid-cols-3 space-x-2 my-3'>
                    <div className="rounded-[17px] border-[4px] border-white relative overflow-hidden shadow-[0_0_9px_0px_rgba(0,0,0,0.095)]">
                        ...
                        <Link href="#" className='z-10 absolute top-2 right-2 h-[26px] w-auto bg-[#222C40]/[0.38] rounded-[8px] px-[7px] text-white flex items-center justify-center'>
                            <Icon icon="ph:heart" width="20" height="20" className="text-white"/>
                        </Link>
                        ...
                        <div className='relative w-[250px] h-[170px]'>
                            <Image className='relative' src='/slider/s-1.png' alt="hill" fill style={{ objectFit: 'cover' }} priority/>
                        </div>
                    </div>
                    <div className="rounded-[17px] border-[4px] border-white relative overflow-hidden shadow-[0_0_9px_0px_rgba(0,0,0,0.095)]">
                        <span className='z-10 absolute top-2 left-2 h-[26px] w-auto bg-[#222C40]/[0.38] rounded-[8px] px-[7px] text-white text-[16px] font-semibold'>$300</span>
                        ...
                        <div className='relative w-[250px] h-[170px]'>
                            <Image className='relative' src='/slider/s-2.png' alt="hill" fill style={{ objectFit: 'cover' }} priority/>
                        </div>
                    </div>
                    <div className="rounded-[17px] border-[4px] border-white relative overflow-hidden shadow-[0_0_9px_0px_rgba(0,0,0,0.095)]">
                        <span className='z-10 absolute top-2 left-2 h-[26px] w-auto bg-[#222C40]/[0.38] rounded-[8px] px-[7px] text-white text-[16px] font-semibold'>$300</span>
                        ...
                        <div className='relative w-[250px] h-[170px]'>
                            <Image className='relative' src='/slider/s-3.png' alt="hill" fill style={{ objectFit: 'cover' }} priority/>
                        </div>
                    </div>
                </div>
            </div>
